...
const StatusCard: React.FC<StatusCardProps> = ({ icon, label, count, color }) => {
  return (
    <div className="bg-white shadow-sm rounded-xl py-6 px-4 flex flex-col border items-start gap-4 min-w-[220px]">
      {icon && (
      ...
      <div className="flex flex-col items-start gap-2">
        <h3 className="text-[24px] font-semibold leading-none">{count}</h3>
